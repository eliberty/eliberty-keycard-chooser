...
var CardNumberField = /*#__PURE__*/function (_React$Component) {
  _inherits(CardNumberField, _React$Component);

  var _super = _createSuper(CardNumberField);
  ...
  _createClass(CardNumberField, [{
    ...
    value: function renderedCardNumberField(mode, params, suggestions, inputProps) {
      return mode !== 'OPEN' && params.get('displayKeycardAutoComplete', false) === true ? /*#__PURE__*/_react["default"].createElement(_reactAutosuggest["default"], {
      ...
      }) : /*#__PURE__*/_react["default"].createElement(_reactTextMask["default"], inputProps);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var inputProps = _objectSpread(_objectSpread({}, configs[mode]), {}, {
        id: cardNumber,
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, this.renderedCardNumberField(mode, params, suggestions, inputProps));
    }
  }]);
